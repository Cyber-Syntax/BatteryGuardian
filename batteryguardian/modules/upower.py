...
def initialize_upower_monitoring(
    ...
    logger.info(
        f"Monitoring AC adapter at {ac_adapter_path}"
        if ac_adapter_path
        else "No AC adapter found"
    )
        ...
        try:
            ...
            try:
                ...
                if battery_path:
                    ...
                    logger.debug(
                        f"Added signal receiver for battery path: {battery_path}"
                    )
                ...
                if ac_adapter_path:
                    ...
                    logger.debug(
                        f"Added signal receiver for AC path: {ac_adapter_path}"
                    )
